...
function Transaction_SQLCordova(client, container) {
...
inherits(Transaction_SQLCordova, EventEmitter)
...
promiseInterface.forEach(function(method) {
  Transaction_SQLCordova.prototype[method] = function() {
    return (this._promise = this._promise[method].apply(this._promise, arguments))
  }
})

export default Transaction_SQLCordova
