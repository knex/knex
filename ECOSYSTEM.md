...
- [`pgfence`](https://github.com/flvmnt/pgfence) A Postgres migration safety CLI that analyzes Knex migrations for dangerous lock patterns and provides safe rewrite recipes. Extracts SQL from `knex.raw()` calls and Knex schema builder methods.
