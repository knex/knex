...
export default (version) => [
  {
    ...
    content: [
      ...
      "You can report bugs and discuss features on the [GitHub issues page](http://github.com/knex/knex/issues), add pages to the [wiki](https://github.com/knex/knex/wiki) or send tweets to [@kibertoad](http://twitter.com/kibertoad).",
