...
Create a schema, specified by the schema's name. Supported by PostgreSQL and MSSQL.
...
Create a schema conditionally if the schema does not exist, specified by the schema's name. Only supported by PostgreSQL.
