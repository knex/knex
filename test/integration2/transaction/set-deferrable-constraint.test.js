...
describe('Transaction', () => {
  describe('setDeferrableConstraint', () => {
    getAllDbs().forEach((db) => {
      const shouldRun = isPostgreSQL(db) || isOracle(db) || isMssql(db);
      describe.runIf(shouldRun)(db, () => {
        let knex;
        ...
        it.only('deferrable initially immediate unique constraint all row are checked at end of update', async () => {
