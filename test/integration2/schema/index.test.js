        ...
        describe(db, () => {
          ...
          describe('dropColumn', () => {
            it('recreates indices after dropping a column without an index', async () => {
              ...
              expect(indicesOneAfter).toEqual(
                expect.arrayContaining(indicesOneBefore)
              );
              expect(indicesTwoAfter).toEqual(
                expect.arrayContaining(indicesTwoBefore)
              );
            });
            ...
            it('drops indices when the corresponding column is dropped', async () => {
              ...
              expect(indicesOneAfter).toEqual(
                expect.arrayContaining(indicesOneBeforeWithoutIndex)
              );
              expect(indicesTwoAfter).toEqual(
                expect.arrayContaining(indicesTwoBeforeWithoutIndex)
              );
            });
          ...
          describe('alterColumns', () => {
            it('recreates indices after altering a column', async () => {
              ...
              expect(indicesAfter).toEqual(
                expect.arrayContaining(indicesBefore)
              );
            });
          });
          ...
          describe('dropPrimary', () => {
            it('recreates indices after dropping a primary key', async () => {
              ...
              expect(indicesAfter).toEqual(
                expect.arrayContaining(indicesBeforeWithoutPrimary)
              );
            });
          });
          ...
          describe('primary', () => {
            it('recreates indices after adding a primary key', async () => {
              ...
              expect(indicesAfterWithoutPrimary).toEqual(
                expect.arrayContaining(indicesBefore)
              );
            });
          });
