        ...
        describe(db, () => {
          ...
          describe('alterColumns', () => {
            it('alters the type of columns', async () => {
              ...
              expect(typeof item_one.column_integer).toBe('string');
              expect(typeof item_one.column_string).toBe('number');
              expect(typeof item_one.column_datetime).toBe('number');
              expect(tableAfter).toBe(
            ...
            it('adds default and not null constraints', async () => {
              ...
              expect(item_two.column_integer).toBe(0);
              expect(item_two.column_datetime).toBe(0);
              await expect(
            ...
            it('removes not specified default and not null constraints', async () => {
              ...
              expect(item_two.column_defaultTo).toBeNull();
              expect(item_two.column_boolean_defaultTo).toBeNull();
              expect(item_two.column_notNullable).toBeNull();
              expect(item_two.column_defaultToAndNotNullable).toBeNull();
              expect(tableAfter).toBe(
            ...
            it('properly changes the default value of a boolean column', async () => {
              ...
              expect(item_two.column_boolean_defaultTo).toBe(1);
              expect(tableAfter).toBe(
