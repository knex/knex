      ...
      describe('view', () => {
        ...
        it('create view', async () => {
          ...
          await knex
            ...
            .then(function (results) {
              ...
              expect(results[0].a).toBe('test2');
              expect(results[1].a).toBe('test3');
            });
        });
        ...
        it('create or replace view', async () => {
          ...
          await knex
            ...
            .then(function (results) {
              ...
              expect(results[0].a).toBe('test');
              expect(results[1].a).toBe('test2');
              expect(results[2].a).toBe('test3');
        ...
        it('alter column view', async function () {
          ...
          await knex
            ...
            .from('view_test')
            .then(function (results) {
              expect(results[0].new_a).toBe('test2');
              expect(results[1].new_a).toBe('test3');
              assertNumber(knex, results[0].b, 12);
              assertNumber(knex, results[1].b, 45);
            });
        });
