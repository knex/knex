  ...
  describe('Schema', function() {
    ...
    describe('createTable', function() {
      ...
      it('is possible to chain .catch', function() {
        return knex.schema.hasTable('catch_test')
        .then(function (exists) {
          if (exists) { return knex.schema.dropTable('catch_test'); }
        })
        .then(function () {
          return knex.schema
      ...
      it('accepts the table name, and a "container" function', function() {
        return knex.schema
          .createTable('test_table_one', function(table) {
            ...
            tester('oracle', [
              'create table "test_table_one" ("id" number(20, 0) not null primary key, "first_name" varchar2(255), "last_name" varchar2(255), "email" varchar2(255) null, "logins" integer default \'1\', "about" varchar2(4000), "created_at" timestamp, "updated_at" timestamp)',
      ...
      it('sets booleans & defaults correctly', function() {
          return knex.schema
            .createTable('bool_test', function(table) {
              ...
              tester('mysql', ['create table `bool_test` (`one` boolean, `two` boolean default \'0\', `three` boolean default \'1\', `four` boolean default \'1\', `five` boolean default \'0\')']);
