  ...
  describe('Schema', function() {
    ...
    describe('createTable', function() {
      ...
      describe('increments types - mysql/maria', function() {
        if (
          ...
          (!/mysql/i.test(knex.client.dialect) &&
            !/maria/i.test(knex.client.dialect))
        ) {
          return Promise.resolve();
        }
      ...
      it('accepts the table name, and a "container" function', function() {
        return knex.schema
          ...
          .testSql(function(tester) {
            ...
            tester('pg', [
              'create table "test_table_one" ("id" bigserial primary key, "first_name" varchar(255), "last_name" varchar(255), "email" varchar(255) null, "logins" integer default \'1\', "about" text, "created_at" timestamptz, "updated_at" timestamptz)',
            ...
            tester('pg-redshift', [
              'create table "test_table_one" ("id" bigint identity(1,1) primary key not null, "first_name" varchar(255), "last_name" varchar(255), "email" varchar(255) null, "logins" integer default \'1\', "about" varchar(max), "created_at" timestamptz, "updated_at" timestamptz)',
              'comment on table "test_table_one" is \'A table comment.\'',
              'comment on column "test_table_one"."logins" is NULL',
              'comment on column "test_table_one"."about" is \'A comment.\'',
              'alter table "test_table_one" add constraint "test_table_one_email_unique" unique ("email")',
            ...
            tester('sqlite3', [
              "create table `test_table_one` (`id` integer not null primary key autoincrement, `first_name` varchar(255), `last_name` varchar(255), `email` varchar(255) null, `logins` integer default '1', `about` text, `created_at` datetime, `updated_at` datetime)",
              'create index `test_table_one_first_name_index` on `test_table_one` (`first_name`)',
            ...
            tester('mssql', [
              "CREATE TABLE [test_table_one] ([id] bigint identity(1,1) not null primary key, [first_name] nvarchar(255), [last_name] nvarchar(255), [email] nvarchar(255) null, [logins] int default '1', [about] nvarchar(max), [created_at] datetime, [updated_at] datetime, CONSTRAINT [test_table_one_email_unique] UNIQUE ([email]))",
              'CREATE INDEX [test_table_one_first_name_index] ON [test_table_one] ([first_name])',
              'CREATE INDEX [test_table_one_logins_index] ON [test_table_one] ([logins])',
            ]);
          });
      ...
      it('rejects setting foreign key where tableName is not typeof === string', function() {
        return knex.schema.createTable('invalid_inTable_param_test', function(
          table
        ) {
      ...
      it('allows for composite keys', function() {
        return knex.schema
          ...
          .testSql(function(tester) {
            ...
            tester('mssql', [
              'CREATE TABLE [composite_key_test] ([column_a] int, [column_b] int, [details] nvarchar(max), [status] tinyint, CONSTRAINT [composite_key_test_column_a_column_b_unique] UNIQUE ([column_a], [column_b]))',
            ]);
          })
          .then(function() {
    ...
    describe('table', function() {
      ...
      it('allows alter column syntax', function() {
        if (
          knex.client.dialect.match('sqlite') !== null ||
        ...
        return knex.schema
          .table('test_table_two', function(t) {
            t
              .integer('remove_not_null')
              .notNull()
              .defaultTo(1);
            t
              .string('remove_default')
              .notNull()
              .defaultTo(1);
            t
