...
describe('knexfile', () => {
  ...
  describe('knexfile resolution', () => {
    describe('--cwd is NOT specified', function () {
      describe('and --knexfile is also NOT specified', function () {
...
module.exports = {
  ...
  migrations: {
    directory: __dirname + '/test//jake-util/knexfile_migrations',
      ...
      describe('but --knexfile is specified', function () {
    ...
    describe('--cwd is specified', function () {
      describe('and --knexfile is also specified', function () {
        describe('and --knexfile is a relative path', function () {
        ...
        describe('and --knexfile is an absolute path', function () {
      ...
      describe('but --knexfile is NOT specified', function () {
