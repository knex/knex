...
test('parses maria connections, aliasing database to db', function(t) {
  ...
  t.deepEqual(
    parseConnection('maria://username:pass@path.to.some-url:6000/testdb'),
    maria
  );
  t.deepEqual(
    parseConnection('mariasql://username:pass@path.to.some-url:6000/testdb'),
    maria
  );
  t.deepEqual(
    parseConnection('mariadb://username:pass@path.to.some-url:6000/testdb'),
    maria
  );
});
