...
describe('QueryBuilder', function() {
  ...
  it('multiple inserts with returning', function() {
    ...
    testsql(
        ...
        ),
      {
        ...
        oracle: {
          sql:
            'begin execute immediate \'insert into "users" ("email", "name") values (:1, :2) returning ROWID into :3\' using ?, ?, out ?; execute immediate \'insert into "users" ("email", "name") values (:1, :2) returning ROWID into :3\' using ?, ?, out ?;end;',
        ...
        ),
      {
        ...
        oracle: {
          ...
          bindings: function(bindings) {
            ...
            expect(bindings[1]).to.equal('taylor');
            expect(bindings[2].toString()).to.equal(
              '[object ReturningHelper:id:name]'
            );
            expect(bindings[3]).to.equal('bar');
            expect(bindings[4]).to.equal('dayle');
            expect(bindings[5].toString()).to.equal(
  ...
  it('insert with array with empty object and returning', function() {
    testsql(
        ...
        .insert([{}], 'id'),
      {
        ...
        oracle: {
          sql:
            'insert into "users" ("id") values (default) returning ROWID into ?',
          bindings: function(bindings) {
  ...
  it('insert get id', function() {
    testsql(
        ...
        .insert({ email: 'foo' }, 'id'),
      {
        ...
        oracle: {
          sql:
            'insert into "users" ("email") values (?) returning ROWID into ?',
          bindings: function(bindings) {
  ...
  it('escapes double quotes property', function() {
    testquery(
      ...
      {
        postgres:
          'select * from "players" where "name" = \'Gerald "Ice" Williams\'',
      }
    );
  });
