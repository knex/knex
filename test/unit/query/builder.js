...
function raw_sqlite(sql, bindings) {
  return clients.sqlite3.raw(sql, bindings);
}

function callQueryBuilderCallback(selectedClients, clientType, callback) {
  var client = selectedClients[clientType];

  return callback(queryBuilderFactory, raw);
...
function verifySqlResult(dialect, expectedObj, sqlObj) {
  (0, _keys2.default)(expectedObj).forEach(function (key) {
...
function testsql(queryBuilderCallback, valuesToCheck, selectedClients) {
  selectedClients = selectedClients || clients;
  (0, _keys2.default)(valuesToCheck).forEach(function (key) {

    var sqlAndBindings = callQueryBuilderCallback(selectedClients, key, queryBuilderCallback).toSQL();
...
function testquery(queryBuilderCallback, valuesToCheck, selectedClients) {
  selectedClients = selectedClients || clients;
  (0, _keys2.default)(valuesToCheck).forEach(function (key) {
    var sqlString = callQueryBuilderCallback(selectedClients, key, queryBuilderCallback).toQuery();
    var checkValue = valuesToCheck[key];
...
describe("QueryBuilder", function () {
  ...
  it("adding selects", function () {
    testsql(function (qb, raw) {
      return qb().select('foo').select('bar').select(['baz', 'boom']).from('users');
    }, {
  ...
  it("basic select distinct", function () {
    testsql(function (qb, raw) {
      return qb().distinct().select('foo', 'bar').from('users');
    }, {
  ...
  it("basic alias", function () {
    testsql(function (qb, raw) {
      return qb().select('foo as bar').from('users');
    }, {
  ...
  it("allows alias with dots in the identifier name", function () {
    testsql(function (qb, raw) {
      return qb().select('foo as bar.baz').from('users');
    }, {
  ...
  it("basic table wrapping", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('public.users');
    }, {
  ...
  it("basic table wrapping with declared schema", function () {
    testsql(function (qb, raw) {
      return qb().withSchema('myschema').select('*').from('users');
    }, {
  ...
  it("selects from only", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users', { only: true });
    }, {
  ...
  it("clear a select", function () {
    testsql(function (qb, raw) {
      return qb().select('id', 'email').from('users').clearSelect();
    }, {
      mysql: {
    ...
    testsql(function (qb, raw) {
      return qb().select('id').from('users').clearSelect().select('email');
    }, {
      mysql: {
  ...
  it("clear a where", function () {
    testsql(function (qb, raw) {
      return qb().select('id').from('users').where('id', '=', 1).clearWhere();
    }, {
      mysql: {
    ...
    testsql(function (qb, raw) {
      return qb().select('id').from('users').where('id', '=', 1).clearWhere().where('id', '=', 2);
    }, {
      mysql: {
  ...
  it("where not", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNot('id', '=', 1);
    }, {
      mysql: {
  ...
  it("grouped or where not", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNot(function () {
  ...
  it("grouped or where not alternate", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(function () {
        this.where('id', '=', 1).orWhereNot('id', '=', 3);
      });
    }, {
      mysql: {
  ...
  it("where not object", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNot({ first_name: 'Test', last_name: 'User' });
    }, {
      mysql: {
  ...
  it('where bool', function () {
    testquery(function (qb, raw) {
      return qb().select('*').from('users').where(true);
    }, {
  ...
  it("where betweens", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereBetween('id', [1, 2]);
    }, {
      mysql: {
  ...
  it("and where betweens", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('name', '=', 'user1').andWhereBetween('id', [1, 2]);
    }, {
      mysql: {
  ...
  it("and where not betweens", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('name', '=', 'user1').andWhereNotBetween('id', [1, 2]);
    }, {
      mysql: {
  ...
  it("where betweens, alternate", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', 'BeTween', [1, 2]);
    }, {
      mysql: {
        sql: 'select * from `users` where `id` between ? and ?',
        bindings: [1, 2]
  ...
  it("where not between", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNotBetween('id', [1, 2]);
    }, {
      mysql: {
  ...
  it("where not between, alternate", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', 'not between ', [1, 2]);
    }, {
      mysql: {
        sql: 'select * from `users` where `id` not between ? and ?',
        bindings: [1, 2]
  ...
  it("basic or wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).orWhere('email', '=', 'foo');
    }, {
      mysql: {
  ...
  it("chained or wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).or.where('email', '=', 'foo');
    }, {
      mysql: {
        sql: 'select * from `users` where `id` = ? or `email` = ?',
        bindings: [1, 'foo']
  ...
  it("raw column wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(raw('LCASE("name")'), 'foo');
    }, {
      mysql: {
  ...
  it("raw wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(raw('id = ? or email = ?', [1, 'foo']));
    }, {
      mysql: {
        sql: 'select * from `users` where id = ? or email = ?',
        bindings: [1, 'foo']
  ...
  it("raw or wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).orWhere(raw('email = ?', ['foo']));
    }, {
      mysql: {
        sql: 'select * from `users` where `id` = ? or email = ?',
        bindings: [1, 'foo']
  ...
  it("chained raw or wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).or.where(raw('email = ?', ['foo']));
    }, {
      mysql: {
        sql: 'select * from `users` where `id` = ? or email = ?',
        bindings: [1, 'foo']
  ...
  it("basic where ins", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereIn('id', [1, 2, 3]);
    }, {
      mysql: {
  ...
  it("orWhereIn", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).orWhereIn('id', [1, 2, 3]);
    }, {
      mysql: {
  ...
  it("basic where not ins", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNotIn('id', [1, 2, 3]);
    }, {
      mysql: {
  ...
  it("chained or where not in", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).or.not.whereIn('id', [1, 2, 3]);
    }, {
      mysql: {
  ...
  it("or.whereIn", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).or.whereIn('id', [4, 2, 3]);
    }, {
      mysql: {
        sql: 'select * from `users` where `id` = ? or `id` in (?, ?, ?)',
        bindings: [1, 4, 2, 3]
  ...
  it("chained basic where not ins", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').not.whereIn('id', [1, 2, 3]);
    }, {
      mysql: {
        sql: 'select * from `users` where `id` not in (?, ?, ?)',
        bindings: [1, 2, 3]
  ...
  it('whereIn with empty array, #477', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereIn('id', []);
    }, {
      mysql: {
  ...
  it('whereNotIn with empty array, #477', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNotIn('id', []);
    }, {
      mysql: {
        sql: 'select * from `users` where 1 = ?',
        bindings: [1]
  ...
  it('should allow a function as the first argument, for a grouped where clause', function () {
    function commonChainForPartial(qb) {
      return qb().table('test').where('id', '=', 1);
    }

    testsql(function (qb, raw) {
      return commonChainForPartial(qb);
    }, {
    ...
    var subWhere = function subWhere(sql) {
      expect(this).to.equal(sql);
      this.where({ id: 3 }).orWhere('id', 4);
    };

    testsql(function (qb, raw) {
      return commonChainForPartial(qb).where(subWhere);
    }, {
      mysql: {
  ...
  it('should accept a function as the "value", for a sub select', function () {
    var chain = function chain(qb, raw) {
      return qb().where('id', '=', function (qb) {
  ...
  it("unions", function () {
    var chain = function chain(qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).union(function () {
    ...
    var multipleArgumentsChain = function multipleArgumentsChain(qb, raw) {
      return qb().select('*').from('users').where({ id: 1 }).union(function () {
        this.select('*').from('users').where({ id: 2 });
      }, function () {
    ...
    var arrayChain = function arrayChain(qb, raw) {
      return qb().select('*').from('users').where({ id: 1 }).union([function () {
        this.select('*').from('users').where({ id: 2 });
      }, function () {
        this.select('*').from('users').where({ id: 3 });
  ...
  it("wraps unions", function () {
    var wrappedChain = function wrappedChain(qb, raw) {
      return qb().select('*').from('users').where('id', 'in', function () {
    ...
    var multipleArgumentsWrappedChain = function multipleArgumentsWrappedChain(qb, raw) {
      return qb().select('*').from('users').where({ id: 1 }).union(function () {
        this.select('*').from('users').where({ id: 2 });
      }, function () {
        this.select('*').from('users').where({ id: 3 });
    ...
    var arrayWrappedChain = function arrayWrappedChain(qb, raw) {
      return qb().select('*').from('users').where({ id: 1 }).union([function () {
        this.select('*').from('users').where({ id: 2 });
      }, function () {
        this.select('*').from('users').where({ id: 3 });
  ...
  //   chain = my(qb,raw)=>qb().union(
  //     raw(my(qb,raw)=>qb().select('*').from('users').where('id', '=', 1)).wrap('(', ')'),
  //     raw(my(qb,raw)=>qb().select('*').from('users').where('id', '=', 2)).wrap('(', ')')
  ...
  it("union alls", function () {
    var chain = function chain(qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).unionAll(function () {
        this.select('*').from('users').where('id', '=', 2);
      });
    };
    testsql(chain, {
  ...
  it("multiple unions", function () {
    var chain = function chain(qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).union(qb().select('*').from('users').where('id', '=', 2)).union(qb().select('*').from('users').where('id', '=', 3));
    };
    testsql(chain, {
      mysql: {
        sql: 'select * from `users` where `id` = ? union select * from `users` where `id` = ? union select * from `users` where `id` = ?',
  ...
  it("multiple union alls", function () {
    var chain = function chain(qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).unionAll(qb().select('*').from('users').where('id', '=', 2)).unionAll(qb().select('*').from('users').where('id', '=', 3));
    };
  ...
  it("sub select where ins", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereIn('id', function (qb) {
  ...
  it("sub select where not ins", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNotIn('id', function (qb) {
  ...
  it("basic where nulls", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNull('id');
    }, {
      mysql: {
  ...
  it("basic or where nulls", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).orWhereNull('id');
    }, {
      mysql: {
  ...
  it("basic where not nulls", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereNotNull('id');
    }, {
      mysql: {
  ...
  it("basic or where not nulls", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '>', 1).orWhereNotNull('id');
    }, {
      mysql: {
  ...
  it("group bys", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').groupBy('id', 'email');
    }, {
      mysql: {
  ...
  it("order bys", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').orderBy('email').orderBy('age', 'desc');
    }, {
      mysql: {
  ...
  it("raw group bys", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').groupByRaw('id, email');
    }, {
      mysql: {
        sql: 'select * from `users` group by id, email',
        bindings: []
  ...
  it("raw order bys with default direction", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').orderBy(raw('col NULLS LAST'));
    }, {
      mysql: {
  ...
  it("raw order bys with specified direction", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').orderBy(raw('col NULLS LAST'), 'desc');
    }, {
      mysql: {
  ...
  it("orderByRaw", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').orderByRaw('col NULLS LAST DESC');
    }, {
      mysql: {
        sql: 'select * from `users` order by col NULLS LAST DESC',
        bindings: []
  ...
  it("havings", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').having('email', '>', 1);
    }, {
  ...
  it("or having", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').having('baz', '>', 5).orHaving('email', '=', 10);
    }, {
  ...
  it("nested having", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').having(function () {
        this.where('email', '>', 1);
      });
    }, {
      mysql: 'select * from `users` having (`email` > ?)',
  ...
  it("grouped having", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').groupBy('email').having('email', '>', 1);
    }, {
  ...
  it("having from", function () {
    testsql(function (qb, raw) {
      return qb().select('email as foo_email').from('users').having('foo_email', '>', 1);
    }, {
  ...
  it("raw havings", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').having(raw('user_foo < user_bar'));
    }, {
  ...
  it("raw or havings", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').having('baz', '=', 1).orHaving(raw('user_foo < user_bar'));
    }, {
  ...
  it("having null", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNull('baz');
    }, {
  ...
  it("or having null", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNull('baz').orHavingNull('foo');
    }, {
  ...
  it("having not null", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotNull('baz');
    }, {
  ...
  it("or having not null", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotNull('baz').orHavingNotNull('foo');
    }, {
  ...
  it("having exists", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingExists(function () {
  ...
  it("having not exists", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotExists(function () {
        this.select('baz').from('users');
      });
    }, {
  ...
  it("having between", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingBetween('baz', [5, 10]);
    }, {
  ...
  it("or having between", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingBetween('baz', [5, 10]).orHavingBetween('baz', [20, 30]);
    }, {
  ...
  it("having not between", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotBetween('baz', [5, 10]);
    }, {
  ...
  it("or having not between", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotBetween('baz', [5, 10]).orHavingNotBetween('baz', [20, 30]);
    }, {
  ...
  it("having in", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingIn('baz', [5, 10, 37]);
    }, {
  ...
  it("or having in", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingIn('baz', [5, 10, 37]).orHavingIn('foo', ['Batman', 'Joker']);
    }, {
  ...
  it("having not in", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotIn('baz', [5, 10, 37]);
    }, {
  ...
  it("or having not in", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').havingNotIn('baz', [5, 10, 37]).orHavingNotIn('foo', ['Batman', 'Joker']);
    }, {
  ...
  it("limits", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').limit(10);
    }, {
      mysql: {
  ...
  it("can limit 0", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').limit(0);
    }, {
      mysql: {
        sql: 'select * from `users` limit ?',
        bindings: [0]
  ...
  it("limits and offsets", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').offset(5).limit(10);
    }, {
      mysql: {
  ...
  it("offsets only", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').offset(5);
    }, {
      mysql: {
  ...
  it("where shortcut", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', 1).orWhere('name', 'foo');
    }, {
      mysql: {
  ...
  it("nested wheres", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('email', '=', 'foo').orWhere(function (qb) {
  ...
  it("full sub selects", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('email', '=', 'foo').orWhere('id', '=', function (qb) {
  ...
  it("clear nested selects", function () {
    testsql(function (qb, raw) {
      return qb().select('email').from('users').where('email', '=', 'foo').orWhere('id', '=', function (qb) {
  ...
  it("where exists", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('orders').whereExists(function (qb) {
  ...
  it("where exists with builder", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('orders').whereExists(qb().select('*').from('products').whereRaw('products.id = orders.id'));
    }, {
      mysql: {
        sql: 'select * from `orders` where exists (select * from `products` where products.id = orders.id)',
        bindings: []
  ...
  it("where not exists", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('orders').whereNotExists(function (qb) {
        qb.select('*').from('products').where('products.id', '=', raw('"orders"."id"'));
      });
    }, {
      mysql: {
  ...
  it("or where exists", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('orders').where('id', '=', 1).orWhereExists(function (qb) {
        qb.select('*').from('products').where('products.id', '=', raw('"orders"."id"'));
      });
    }, {
      mysql: {
  ...
  it("or where not exists", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('orders').where('id', '=', 1).orWhereNotExists(function (qb) {
        qb.select('*').from('products').where('products.id', '=', raw('"orders"."id"'));
      });
    }, {
      mysql: {
  ...
  it("basic joins", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').join('contacts', 'users.id', '=', 'contacts.id').leftJoin('photos', 'users.id', '=', 'photos.id');
    }, {
      mysql: {
  ...
  it("complex join", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').join('contacts', function (qb) {
  ...
  it("joins with raw", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').join('contacts', 'users.id', raw(1)).leftJoin('photos', 'photos.title', '=', raw('?', ['My Photo']));
    }, {
      mysql: {
  ...
  it("joins with schema", function () {
    testsql(function (qb, raw) {
      return qb().withSchema('myschema').select('*').from('users').join('contacts', 'users.id', '=', 'contacts.id').leftJoin('photos', 'users.id', '=', 'photos.id');
    }, {
      mysql: {
  ...
  it("raw expressions in select", function () {
    testsql(function (qb, raw) {
      return qb().select(raw('substr(foo, 6)')).from('users');
    }, {
      mysql: {
  ...
  it("count distinct", function () {
    testsql(function (qb, raw) {
      return qb().from('users').countDistinct();
    }, {
      mysql: {
  ...
  it("count with alias", function () {
    testsql(function (qb, raw) {
      return qb().from('users').count('* as all');
    }, {
      mysql: {
  ...
  it("count distinct with alias", function () {
    testsql(function (qb, raw) {
      return qb().from('users').countDistinct('* as all');
    }, {
      mysql: {
  ...
  it("sum distinct", function () {
    testsql(function (qb, raw) {
      return qb().from('users').sumDistinct('id');
    }, {
      mysql: {
  ...
  it("insert method", function () {
    testsql(function (qb, raw) {
      return qb().into('users').insert({ 'email': 'foo' });
    }, {
      mysql: {
  ...
  it("multiple inserts", function () {
    testsql(function (qb, raw) {
      return qb().from('users').insert([{ email: 'foo', name: 'taylor' }, { email: 'bar', name: 'dayle' }]);
    }, {
      mysql: {
  ...
  it("multiple inserts with partly undefined keys client with configuration nullAsDefault: true", function () {
    testquery(function (qb, raw) {
      return qb().from('users').insert([{ email: 'foo', name: 'taylor' }, { name: 'dayle' }]);
    }, {
  ...
  it("multiple inserts with returning", function () {
    ...
    testsql(function (qb, raw) {
      return qb().from('users').insert([{ email: 'foo', name: 'taylor' }, { email: 'bar', name: 'dayle' }], 'id');
    }, {
      mysql: {
        sql: 'insert into `users` (`email`, `name`) values (?, ?), (?, ?)',
        bindings: ['foo', 'taylor', 'bar', 'dayle']
      ...
      oracle: {
        ...
        bindings: function bindings(_bindings) {
          expect(_bindings.length).to.equal(6);
          expect(_bindings[0]).to.equal('foo');
          expect(_bindings[1]).to.equal('taylor');
          expect(_bindings[2].toString()).to.equal('[object ReturningHelper:id]');
          expect(_bindings[3]).to.equal('bar');
          expect(_bindings[4]).to.equal('dayle');
          expect(_bindings[5].toString()).to.equal('[object ReturningHelper:id]');
        }
      },
      mssql: {
      ...
      oracledb: {
        ...
        bindings: function bindings(_bindings2) {
          expect(_bindings2.length).to.equal(6);
          expect(_bindings2[0]).to.equal('foo');
          expect(_bindings2[1]).to.equal('taylor');
          expect(_bindings2[2].toString()).to.equal('[object ReturningHelper:id]');
          expect(_bindings2[3]).to.equal('bar');
          expect(_bindings2[4]).to.equal('dayle');
          expect(_bindings2[5].toString()).to.equal('[object ReturningHelper:id]');
        }
      }
    });
  });
  ...
  it("multiple inserts with multiple returning", function () {
    testsql(function (qb, raw) {
      return qb().from('users').insert([{ email: 'foo', name: 'taylor' }, { email: 'bar', name: 'dayle' }], ['id', 'name']);
    }, {
      mysql: {
        sql: 'insert into `users` (`email`, `name`) values (?, ?), (?, ?)',
        bindings: ['foo', 'taylor', 'bar', 'dayle']
      ...
      oracle: {
        sql: "begin execute immediate 'insert into \"users\" (\"email\", \"name\") values (:1, :2) returning ROWID into :3' using ?, ?, out ?; execute immediate 'insert into \"users\" (\"email\", \"name\") values (:1, :2) returning ROWID into :3' using ?, ?, out ?;end;",
        bindings: function bindings(_bindings3) {
          expect(_bindings3.length).to.equal(6);
          expect(_bindings3[0]).to.equal('foo');
          expect(_bindings3[1]).to.equal('taylor');
          expect(_bindings3[2].toString()).to.equal('[object ReturningHelper:id:name]');
          expect(_bindings3[3]).to.equal('bar');
          expect(_bindings3[4]).to.equal('dayle');
          expect(_bindings3[5].toString()).to.equal('[object ReturningHelper:id:name]');
        }
      },
      mssql: {
      ...
      oracledb: {
        ...
        bindings: function bindings(_bindings4) {
          expect(_bindings4.length).to.equal(8);
          expect(_bindings4[0]).to.equal('foo');
          expect(_bindings4[1]).to.equal('taylor');
          expect(_bindings4[2].toString()).to.equal('[object ReturningHelper:id]');
          expect(_bindings4[3].toString()).to.equal('[object ReturningHelper:name]');
          expect(_bindings4[4]).to.equal('bar');
          expect(_bindings4[5]).to.equal('dayle');
          expect(_bindings4[6].toString()).to.equal('[object ReturningHelper:id]');
          expect(_bindings4[7].toString()).to.equal('[object ReturningHelper:name]');
        }
      }
    });
  });
  ...
  it("insert method respects raw bindings", function () {
    testsql(function (qb, raw) {
      return qb().insert({ 'email': raw('CURRENT TIMESTAMP') }).into('users');
    }, {
      mysql: {
  ...
  it("normalizes for missing keys in insert", function () {
    ...
    testsql(function (qb, raw) {
      return qb().insert(data).into('table');
    }, {
      mysql: {
  ...
  it("insert with array with empty object and returning", function () {
    testsql(function (qb, raw) {
      return qb().into('users').insert([{}], 'id');
    }, {
      mysql: {
      ...
      oracle: {
        ...
        bindings: function bindings(_bindings5) {
          expect(_bindings5.length).to.equal(1);
          expect(_bindings5[0].toString()).to.equal('[object ReturningHelper:id]');
        }
      },
      mssql: {
      ...
      oracledb: {
        ...
        bindings: function bindings(_bindings6) {
          expect(_bindings6.length).to.equal(1);
          expect(_bindings6[0].toString()).to.equal('[object ReturningHelper:id]');
        }
      }
    });
  });
  ...
  //   testsql((qb,raw)=>qb().into('users').insert([null], 'id'), {
  //     mysql: {
  //       sql: '',
  //       bindings: []
  //     },
  ...
  //   testsql((qb,raw)=>qb().into('users').insert([null, null]), {
  //     mysql: {
  //       sql: '',
  //       bindings: []
  //     },
  ...
  it("update method", function () {
    testsql(function (qb, raw) {
      return qb().update({ 'email': 'foo', 'name': 'bar' }).table('users').where('id', '=', 1);
    }, {
      mysql: {
  ...
  it("update only method", function () {
    testsql(function (qb, raw) {
      return qb().update({ 'email': 'foo', 'name': 'bar' }).table('users', { only: true }).where('id', '=', 1);
    }, {
      postgres: {
  ...
  it("should not update columns undefined values", function () {
    testsql(function (qb, raw) {
      return qb().update({ 'email': 'foo', 'name': undefined }).table('users').where('id', '=', 1);
    }, {
      mysql: {
  ...
  it("should allow for 'null' updates", function () {
    testsql(function (qb, raw) {
      return qb().update({ email: null, 'name': 'bar' }).table('users').where('id', 1);
    }, {
      mysql: {
        sql: 'update `users` set `email` = ?, `name` = ? where `id` = ?',
        bindings: [null, 'bar', 1]
  ...
  it("order by, limit", function () {
    ...
    testsql(function (qb, raw) {
      return qb().from('users').where('id', '=', 1).orderBy('foo', 'desc').limit(5).update({ email: 'foo', name: 'bar' });
    }, {
      mysql: {
  ...
  it("update method with joins mysql", function () {
    testsql(function (qb, raw) {
      return qb().from('users').join('orders', 'users.id', 'orders.user_id').where('users.id', '=', 1).update({ 'email': 'foo', 'name': 'bar' });
    }, {
      mysql: {
  ...
  it("update method with limit mysql", function () {
    ...
    testsql(function (qb, raw) {
      return qb().from('users').where('users.id', '=', 1).update({ 'email': 'foo', 'name': 'bar' }).limit(1);
    }, {
      mysql: {
  ...
  it("update method without joins on postgres", function () {
    testsql(function (qb, raw) {
      return qb().from('users').where('id', '=', 1).update({ email: 'foo', name: 'bar' });
    }, {
      mysql: {
        sql: 'update `users` set `email` = ?, `name` = ? where `id` = ?',
        bindings: ['foo', 'bar', 1]
  ...
  it("update method with returning on oracle", function () {
    testsql(function (qb, raw) {
      ...
      oracle: {
        ...
        bindings: function bindings(_bindings7) {
          expect(_bindings7.length).to.equal(4);
          expect(_bindings7[0]).to.equal('foo');
          expect(_bindings7[1]).to.equal('bar');
          expect(_bindings7[2]).to.equal(1);
          expect(_bindings7[3].toString()).to.equal('[object ReturningHelper:*]');
        }
      }
    });
  });
  ...
  //   chain = (qb,raw)=>qb().from('users').join('orders', 'users.id', '=', 'orders.user_id').where('users.id', '=', 1).update({email: 'foo', name: 'bar'}).toSQL();
  ...
  it("update method respects raw", function () {
    testsql(function (qb, raw) {
      return qb().from('users').where('id', '=', 1).update({ email: raw('foo'), name: 'bar' });
    }, {
      mysql: {
  ...
  it("delete method", function () {
    testsql(function (qb, raw) {
      return qb().from('users').where('email', '=', 'foo').delete();
    }, {
      mysql: {
  ...
  it("delete only method", function () {
    testsql(function (qb, raw) {
      return qb().from('users', { only: true }).where('email', '=', 'foo').delete();
    }, {
      postgres: {
  ...
  it("truncate method", function () {
    testsql(function (qb, raw) {
      return qb().table('users').truncate();
    }, {
      mysql: {
        sql: 'truncate `users`',
        bindings: []
      ...
      sqlite3: {
        ...
        output: function output(_output) {
          expect(typeof _output === 'undefined' ? 'undefined' : (0, _typeof3.default)(_output)).to.equal('function');
        }
      },
      postgres: {
  ...
  it("insert get id", function () {
    testsql(function (qb, raw) {
      return qb().from('users').insert({ email: 'foo' }, 'id');
    }, {
      mysql: {
        sql: 'insert into `users` (`email`) values (?)',
        bindings: ['foo']
      ...
      oracle: {
        ...
        bindings: function bindings(_bindings8) {
          expect(_bindings8.length).to.equal(2);
          expect(_bindings8[0]).to.equal('foo');
          expect(_bindings8[1].toString()).to.equal('[object ReturningHelper:id]');
        }
      },
      mssql: {
      ...
      oracledb: {
        ...
        bindings: function bindings(_bindings9) {
          expect(_bindings9.length).to.equal(2);
          expect(_bindings9[0]).to.equal('foo');
          expect(_bindings9[1].toString()).to.equal('[object ReturningHelper:id]');
        }
      }
    });
  });
  ...
  it("order by desc", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').orderBy('email', 'desc');
    }, {
  ...
  it("providing null or false as second parameter builds correctly", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('foo', null);
    }, {
  ...
  //   testsql((qb,raw)=>qb().transacting({}).select('*').from('foo').where('bar', '=', 'baz').forShare(), {
  //     mysql: {
  ...
  it("should warn when trying to use forUpdate outside of a transaction", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('foo').where('bar', '=', 'baz').forUpdate();
    }, {
      mysql: {
        sql: 'select * from `foo` where `bar` = ?',
        bindings: ['baz']
  ...
  it('allows insert values of sub-select, #121', function () {
    testsql(function (qb, raw) {
      return qb().table('entries').insert({
        secret: 123,
  ...
  it('allows left outer join with raw values', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('student').leftOuterJoin('student_languages', function () {
  ...
  it('should not break with null call #182', function () {
    testsql(function (qb, raw) {
      return qb().from('test').limit(null).offset(null);
    }, {
      mysql: {
  ...
  it('allows passing builder into where clause, #162', function () {
    function chain(qb) {
      return qb().from('chapter').select('id').where('book', 1);
    }
    function page(qb) {
      return qb().from('page').select('id').whereIn('chapter_id', chain(qb));
    }
    function word(qb) {
      return qb().from('word').select('id').whereIn('page_id', page(qb));
    }

    testsql(function (qb, raw) {
      return word(qb).clone().del();
    }, {
      mysql: {
  ...
  it('allows specifying the columns and the query for insert, #211', function () {
    ...
    testsql(function (qb, raw) {
      return qb().into(raw('recipients (recipient_id, email)')).insert(qb().select(raw('?, ?', [id, email])).whereNotExists(function () {
  ...
  it('does an update with join on mysql, #191', function () {
    ...
    var query = function query(qb, raw) {
      return qb().table('tblPerson').update(setObj).join('tblPersonData', 'tblPersonData.PersonId', '=', 'tblPerson.PersonId').where('tblPersonData.DataId', 1).where('tblPerson.PersonId', 5);
    };
  ...
  it('does crazy advanced inserts with clever raw use, #211', function () {
    var q1 = function q1(qb, raw) {
      return qb().select(raw("'user'"), raw("'user@foo.com'")).whereNotExists(function () {
        this.select(1).from('recipients').where('recipient_id', 1);
      });
    };
    var q2 = function q2(qb, raw) {
      return qb().table('recipients').insert(raw('(recipient_id, email) ?', [q1(qb, raw)]));
    };
  ...
  it('supports capitalized operators', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('name', 'LIKE', '%test%');
    }, {
      mysql: {
  ...
  it('supports POSIX regex operators in Postgres', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('name', '~', '.*test.*');
    }, {
      postgres: {
  ...
  it('throws if you try to use an invalid operator', function () {
    expect(function () {
      qb_sqlite().select('*').where('id', 'isnt', 1).toString();
  ...
  it('throws if you try to use an invalid operator in an inserted statement', function () {
    var obj = qb_sqlite().select('*').where('id', 'isnt', 1);
    expect(function () {
      qb_sqlite().select('*').from('users').where('id', 'in', obj).toString();
    }).to.throw("The operator \"isnt\" is not permitted");
  });
  ...
  it("#287 - wraps correctly for arrays", function () {
    ...
    testsql(function (qb, raw) {
      return qb().select('*').from('value').join('table', 'table.array_column[1]', '=', raw('?', 1));
    }, {
      mysql: {
  ...
  it('allows wrap on raw to wrap in parens and alias', function () {
    testsql(function (qb, raw) {
      return qb().select('e.lastname', 'e.salary', raw(qb().select('avg(salary)').from('employee').whereRaw('dept_no = e.dept_no')).wrap('(', ') avg_sal_dept')).from('employee as e').where('dept_no', '=', 'e.dept_no');
    }, {
      // mysql: {
  ...
  it('allows select as syntax', function () {
    testsql(function (qb, raw) {
      return qb().select('e.lastname', 'e.salary', qb().select('avg(salary)').from('employee').whereRaw('dept_no = e.dept_no').as('avg_sal_dept')).from('employee as e').where('dept_no', '=', 'e.dept_no');
    }, {
      mysql: {
  ...
  it('allows function for subselect column', function () {
    testsql(function (qb, raw) {
      return qb().select('e.lastname', 'e.salary').select(function () {
        this.select('avg(salary)').from('employee').whereRaw('dept_no = e.dept_no').as('avg_sal_dept');
      }).from('employee as e').where('dept_no', '=', 'e.dept_no');
    }, {
      mysql: {
        sql: 'select `e`.`lastname`, `e`.`salary`, (select `avg(salary)` from `employee` where dept_no = e.dept_no) as `avg_sal_dept` from `employee` as `e` where `dept_no` = ?',
        bindings: ["e.dept_no"]
  ...
  it('allows first as syntax', function () {
    testsql(function (qb, raw) {
      return qb().select('e.lastname', 'e.salary', qb().first('salary').from('employee').whereRaw('dept_no = e.dept_no').orderBy('salary', 'desc').as('top_dept_salary')).from('employee as e').where('dept_no', '=', 'e.dept_no');
    }, {
      mysql: {
  ...
  it('supports arbitrarily nested raws', function () {
    var chain = function chain(qb, raw) {
      return qb().select('*').from('places').where(raw('ST_DWithin((places.address).xy, ?, ?) AND ST_Distance((places.address).xy, ?) > ? AND ?', [raw('ST_SetSRID(?,?)', [raw('ST_MakePoint(?,?)', [-10, 10]), 4326]), 100000, raw('ST_SetSRID(?,?)', [raw('ST_MakePoint(?,?)', [-5, 5]), 4326]), 50000, raw('places.id IN ?', [[1, 2, 3]])]));
    };
  ...
  it('has joinRaw for arbitrary join clauses', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('accounts').joinRaw('natural full join table1').where('id', 1);
    }, {
      mysql: {
  ...
  it('allows a raw query in the second param', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('accounts').innerJoin('table1', raw('ST_Contains(buildings_pluto.geom, ST_Centroid(buildings_building.geom))'));
    }, {
      mysql: {
  ...
  it('allows join "using"', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('accounts').innerJoin('table1', function () {
        this.using('id');
      });
    }, {
      mysql: {
  ...
  it('allows sub-query function on insert, #427', function () {
    testsql(function (qb, raw) {
      return qb().into('votes').insert(function () {
  ...
  it('allows sub-query chain on insert, #427', function () {
    testsql(function (qb, raw) {
      return qb().into('votes').insert(qb().select('*').from('votes').where('id', 99));
    }, {
      mysql: {
        sql: 'insert into `votes` select * from `votes` where `id` = ?',
        bindings: [99]
  ...
  it('allows for raw values in join, #441', function () {
    testsql(function (qb, raw) {
      return qb().select('A.nid AS id').from(raw('nidmap2 AS A')).innerJoin(raw(['SELECT MIN(nid) AS location_id', 'FROM nidmap2'].join(' ')).wrap('(', ') AS B'), 'A.x', '=', 'B.x');
    }, {
      mysql: {
  ...
  it('correctly orders parameters when selecting from subqueries, #704', function () {
    testsql(function (qb, raw) {
      return qb().select(raw('?', ['outer raw select']), 'g.f').from(qb().select(raw('? as f', ['inner raw select'])).as('g')).where('g.secret', 123);
    }, {
      mysql: {
  ...
  it('escapes queries properly, #737', function () {
    testsql(function (qb, raw) {
      return qb().select('id","name', 'id`name').from('test`');
    }, {
      mysql: {
  ...
  it('has a modify method which accepts a function that can modify the query', function () {
    ...
    var withBars = function withBars(queryBuilder, table, fk) {
    ...
    testsql(function (qb, raw) {
      return qb().select('foo_id').from('foos').modify(withBars, 'foos', 'bar_id');
    }, {
      mysql: {
  ...
  it('Allows for empty where #749', function () {
    testsql(function (qb, raw) {
      return qb().select('foo').from('tbl').where(function () {});
    }, {
  ...
  it("escapes single quotes properly", function () {
    testquery(function (qb, raw) {
      return qb().select('*').from('users').where('last_name', 'O\'Brien');
    }, {
  ...
  it("escapes double quotes property", function () {
    testquery(function (qb, raw) {
      return qb().select('*').from('players').where('name', 'Gerald "Ice" Williams');
    }, {
  ...
  it('escapes backslashes properly', function () {
    testquery(function (qb, raw) {
      return qb().select('*').from('files').where('path', 'C:\\test.txt');
    }, {
  ...
  it("allows join without operator and with value 0 #953", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').join('photos', 'photos.id', 0);
    }, {
      mysql: {
  ...
  it("where with date object", function () {
    var date = new Date();
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where("birthday", ">=", date);
    }, {
      mysql: {
  ...
  it("raw where with date object", function () {
    var date = new Date();
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereRaw("birthday >= ?", date);
    }, {
      mysql: {
        sql: 'select * from `users` where birthday >= ?',
        bindings: [date]
  ...
  it('#965 - .raw accepts Array and Non-Array bindings', function () {
    var expected = function expected(fieldName, expectedBindings) {
      return {
        mysql: {
    ...
    //String
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(raw('username = ?', 'knex'));
    ...
    //Number
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(raw('isadmin = ?', 0));
    }, expected('isadmin', [0]));
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(raw('isadmin = ?', [1]));
    }, expected('isadmin', [1]));
    ...
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where(raw('updtime = ?', date));
  ...
  it("#1118 orWhere({..}) generates or (and - and - and)", function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).orWhere({
        email: 'foo',
        id: 2
      });
    }, {
  ...
  it('#1228 Named bindings', function () {
    testsql(function (qb, raw) {
      return qb().select('*').from('users').whereIn('id', raw('select (:test)', { test: [1, 2, 3] }));
    }, {
      mysql: {
  ...
  it('#1268 - valueForUndefined should be in toSQL(QueryCompiler)', function () {
    testsql(function (qb, raw) {
      return qb().insert([{ id: void 0, name: 'test', occupation: void 0 }, { id: 1, name: void 0, occupation: 'none' }]).into('users');
    }, {
      mysql: {
  ...
  it('#1402 - raw should take "not" into consideration in querybuilder', function () {
    testsql(function (qb, raw) {
      return qb().from('testtable').whereNot(raw('is_active'));
    }, {
      mysql: {
  ...
  it('Any undefined binding in a SELECT/UPDATE query should throw an error', function () {
    var qbuilders = [function (qb, raw) {
      return qb().from('accounts').where({ Login: void 0 }).select();
    }, function (qb, raw) {
      return qb().from('accounts').where('Login', void 0).select();
    }, function (qb, raw) {
      return qb().from('accounts').where('Login', '>=', void 0).select();
    }, function (qb, raw) {
      return qb().from('accounts').whereIn('Login', ['test', 'val', void 0]).select();
    }, function (qb, raw) {
      return qb().from('accounts').where({ Login: ['1', '2', '3', void 0] });
    }, function (qb, raw) {
      return qb().from('accounts').where({ Login: { Test: '123', Value: void 0 } });
    }, function (qb, raw) {
      return qb().from('accounts').where({ Login: ['1', ['2', [void 0]]] });
    }, function (qb, raw) {
      return qb().from('accounts').update({ test: '1', test2: void 0 }).where({ abc: 'test', cba: void 0 });
    }];
    qbuilders.forEach(function (qbuilder) {
      ...
      try {
        ...
        expect(error.message).to.contain('Undefined binding(s) detected when compiling ' + queryChain._method.toUpperCase() + ' query:'); //This test is not for asserting correct queries
      }
    });
  });
  ...
  it('Any undefined binding in a RAW query should throw an error', function () {
    ...
    var raws = [raw_sqlite('?', [undefined]), raw_sqlite(':col = :value', { col: 'test', value: void 0 }), raw_sqlite('? = ?', ['test', void 0]), raw_sqlite('? = ?', ['test', { test: void 0 }]), raw_sqlite('?', [['test', void 0]])];
  ...
  it('Support escaping of named bindings', function () {
    ...
    var raws = [[raw_sqlite(':a: = :b OR :c', namedBindings), '`foo` = ? OR ?', [namedBindings.b, namedBindings.c]], [raw_sqlite(':a: = \\:b OR :c', namedBindings), '`foo` = :b OR ?', [namedBindings.c]], [raw_sqlite('\\:a: = :b OR :c', namedBindings), ':a: = ? OR ?', [namedBindings.b, namedBindings.c]], [raw_sqlite(':a: = \\:b OR \\:c', namedBindings), '`foo` = :b OR :c', []], [raw_sqlite('\\:a: = \\:b OR \\:c', namedBindings), ':a: = :b OR :c', []]];
  ...
  it('Respect casting with named bindings', function () {
    ...
    var raws = [[raw_sqlite(':a: = :b::TEXT OR :c', namedBindings), '`foo` = ?::TEXT OR ?', [namedBindings.b, namedBindings.c]], [raw_sqlite(':a: = :b::TEXT OR :c::TEXT', namedBindings), '`foo` = ?::TEXT OR ?::TEXT', [namedBindings.b, namedBindings.c]], [raw_sqlite(":a: = 'bar'::TEXT OR :b OR :c::TEXT", namedBindings), '`foo` = \'bar\'::TEXT OR ? OR ?::TEXT', [namedBindings.b, namedBindings.c]], [raw_sqlite(":a:::TEXT = OR :b::TEXT OR :c", namedBindings), '`foo`::TEXT = OR ?::TEXT OR ?', [namedBindings.b, namedBindings.c]], [raw_sqlite('\\:a: = :b::TEXT OR :c', namedBindings), ':a: = ?::TEXT OR ?', [namedBindings.b, namedBindings.c]], [raw_sqlite(':a: = \\:b::TEXT OR \\:c', namedBindings), '`foo` = :b::TEXT OR :c', []], [raw_sqlite('\\:a: = \\:b::TEXT OR \\:c', namedBindings), ':a: = :b::TEXT OR :c', []]];
  ...
  it("query \\\\? escaping", function () {
    testquery(function (qb, raw) {
      return qb().select('*').from('users').where('id', '=', 1).whereRaw('?? \\? ?', ['jsonColumn', 'jsonKey?']);
    }, {
  ...
  it("wrapped 'with' clause select", function () {
    testsql(function (qb, raw) {
      return qb().with('withClause', function () {
        this.select('foo').from('users');
  ...
  it("raw 'with' clause", function () {
    testsql(function (qb, raw) {
      return qb().with('withRawClause', raw('select "foo" as "baz" from "users"')).select('*').from('withRawClause');
    }, {
  ...
  it("chained wrapped 'with' clause", function () {
    testsql(function (qb, raw) {
      return qb().with('firstWithClause', function () {
        this.select('foo').from('users');
  ...
  it("nested 'with' clause with bindings", function () {
    testsql(function (qb, raw) {
      return qb().with('withClause', function () {
        this.with('withSubClause', raw('select "foo" as "baz" from "users" where "baz" > ? and "baz" < ?', [1, 20])).select('*').from('withSubClause');
  ...
  it('#1710, properly escapes arrays in where clauses in postgresql', function () {
    testquery(function (qb, raw) {
      return qb().select('*').from('sometable').where('array_field', '&&', [7]);
    }, {
      postgres: "select * from \"sometable\" where \"array_field\" && '{7}'"
    });
    testquery(function (qb, raw) {
      return qb().select('*').from('sometable').where('array_field', '&&', ['abc', 'def']);
    }, {
      postgres: "select * from \"sometable\" where \"array_field\" && '{\"abc\",\"def\"}'"
    });
    testquery(function (qb, raw) {
      return qb().select('*').from('sometable').where('array_field', '&&', ['abc', 'def', ['g', 2]]);
    }, {
  ...
  it('#2003, properly escapes objects with toPostgres specialization', function () {
    ...
    testquery(function (qb, raw) {
      return qb().table('sometable').insert({ id: new TestObject() });
    }, {
