...
describe('SQLite SchemaBuilder', function () {
  it('basic create table', function () {
    ...
    expect(tableSql[0].sql).toBe('create table `users` (`id` integer not null primary key autoincrement, `email` varchar(255))');
  });
  ...
  it('basic create table like', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` as select * from `users_like` where 0=1');
  });
  ...
  it('test create table like with additionnal columns', function () {
    ...
    expect(tableSql.toSQL().length).toBe(3);
    ...
    expect(tableSql.toSQL()[2].sql).toBe(
  ...
  describe('views', function () {
    ...
    it('create view or replace', async function () {
      const viewSql = client
        ...
        .toSQL();
      expect(viewSql.length).toBe(2);
      expect(viewSql[0].sql).toBe('drop view if exists `adults`');
      expect(viewSql[1].sql).toBe(
        "create view `adults` (`name`) as select `name` from `users` where `age` > '18'"
      );
    });
    ...
    it('create view with check options', async function () {
      expect(() => {
        client
          ...
          .toSQL();
      }).toThrow('check option definition is not supported by this dialect.');
    });
  ...
  it('basic create table without primary key', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`id` integer not null primary key autoincrement)');
  });
  ...
  it('drop unique', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('drop index `users_foo_unique`');
  });
  ...
  it('drop unique if exists', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('drop index if exists `users_foo_unique`');
  });
  ...
  it('drop unique if exists, custom', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('drop index if exists `foo`');
  });
  ...
  it('rename table', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` rename to `foo`');
  });
  ...
  it('adding primary key', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`foo` varchar(255), primary key (`foo`))');
  });
  ...
  it('adding primary key with specific identifier', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`foo` varchar(255), constraint `pk-users` primary key (`foo`))');
  });
  ...
  it('adding composite primary key', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`foo` varchar(255), `order_id` varchar(255), primary key (`foo`, `order_id`))');
  });
  ...
  it('adding composite primary key with specific identifier', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`foo` varchar(255), `order_id` varchar(255), constraint `pk-users` primary key (`foo`, `order_id`))');
  });
  ...
  it('adding foreign key', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`foo` varchar(255), `order_id` varchar(255), foreign key(`order_id`) references `orders`(`id`), primary key (`foo`))');
  });
  ...
  it('adding foreign key with specific identifier', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create table `users` (`foo` varchar(255), `order_id` varchar(255), constraint `fk-users-orders` foreign key(`order_id`) references `orders`(`id`), primary key (`foo`))');
  });
  ...
  it('adds a unique key with autogenerated name', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create unique index `users_foo_unique` on `users` (`foo`)');
  });
  ...
  it('adding unique key with specific name', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create unique index `bar` on `users` (`foo`)');
  });
  ...
  it('adding index', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('create index `baz` on `users` (`foo`, `bar`)');
  });
  ...
  it('adding incrementing id', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `id` integer not null primary key autoincrement');
  });
  ...
  it('adding string', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` varchar(255)');
  });
  ...
  it('allows setting a value in the string length, although unused by sqlite3', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` varchar(100)');
  });
  ...
  it('correctly interprets defaultTo(null)', function () {
    ...
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` varchar(255) default null');
  });
  ...
  it('adding text', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` text');
  });
  ...
  it('adding big integer', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` bigint');
  });
  ...
  it('bigincrements works the same as increments for sqlite3', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` integer not null primary key autoincrement');
  });
  ...
  it('adding integer', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` integer');
  });
  ...
  it('adding tiny integer', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` tinyint');
  });
  ...
  it('adding float', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` float');
  });
  ...
  it('adding boolean', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` boolean');
  });
  ...
  it('adding date', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` date');
  });
  ...
  it('adding date time', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` datetime');
  });
  ...
  it('adding time', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` time');
  });
  ...
  it('adding binary', function () {
    ...
    expect(tableSql.length).toBe(1);
    expect(tableSql[0].sql).toBe('alter table `users` add column `foo` blob');
  });
  ...
  it('allows for on delete cascade with foreign keys, #166', function () {
    ...
    expect(tableSql.length).toBe(2);
    expect(tableSql[0].sql).toBe('create table `users` (`user_id` varchar(36), foreign key(`user_id`) references `user`(`id`) on delete CASCADE)');
  });
