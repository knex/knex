...
(0, _lodash.assign)(QueryCompiler_MSSQL.prototype, {
  ...
  columnInfo: function columnInfo() {
    ...
    var sql = 'select [COLUMN_NAME], [COLUMN_DEFAULT], [DATA_TYPE], [CHARACTER_MAXIMUM_LENGTH], [IS_NULLABLE] from information_schema.columns where table_name = ? and table_catalog = ?';
