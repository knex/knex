...
var trigger = {
  renameColumnTrigger: function renameColumnTrigger(
    logger,
    tableName,
    columnName,
    to
  ) {
    var triggerName = utils.generateCombinedName(
      logger,
      'autoinc_trg',
      tableName
    );
  ...
  createAutoIncrementTrigger: function createAutoIncrementTrigger(
    ...
    return (
      ...
      ('        select count("\' || PK_NAME || \'") into checking from "' +
        tableName +
        '"') +
  ...
  renameTableAndAutoIncrementTrigger: function renameTableAndAutoIncrementTrigger(
    logger,
    tableName,
    to
  ) {
