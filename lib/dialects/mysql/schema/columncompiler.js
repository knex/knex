...
function supportsPreciseTimestamps(client) {
  if (!client.version) {
    const message = 'To get rid of this warning you should specify the mysql dialect version in ' + 'your knex configuration. Currently this defaults to 5.5, but in a future ' + 'release it will default to 5.6 which supports high precision timestamps. ' + 'See http://knexjs.org/#Schema-timestamps for more information.';
