// SQLJS_DDL
//
// All of the SQLJS specific DDL helpers for renaming/dropping
...
const {
  ...
  setForeignCheck,
  executeForeignCheck,
} = require('./internal/sqljs-ddl-operations');
...
// So altering the schema in SQLJS is a major pain.
