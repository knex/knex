...
class TableCompiler_PG extends TableCompiler {
  ...
  primary(columns, constraintName, deferrable) {
    if (isObject(columns)) {
      ({ columns, constraintName, deferrable } = columns);
    } else if (isObject(constraintName)) {
  ...
  unique(columns, indexName, deferrable) {
    if (isObject(columns)) {
      ({ columns, indexName, deferrable } = columns);
    } else if (isObject(indexName)) {
