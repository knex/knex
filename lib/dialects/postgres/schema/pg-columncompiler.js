...
const { isObject, isNumber } = require('../../../util/is');
const { toNumber } = require('../../../util/helpers');
// we want to escape any and all single quotes. Even ones that are in a row.
// eg: COMMENT ON table IS 'This is a '''comment' <- all three quotes need escaping.
...
class ColumnCompiler_PG extends ColumnCompiler {
  ...
  datetime(withoutTz = false, precision) {
    const defaultPrecision = isNumber(
