...
class Client_SQLite3 extends Client {
  ...
  // "cast as json" in Sqlite3 return "0" value instead of json so need to cast in text instead.
  castJson(value, alias) {
    return new Cast(this).castText(value, alias);
  }

  // "cast as jsonb" in Sqlite3 return "0" value instead of json so need to cast in text instead.
