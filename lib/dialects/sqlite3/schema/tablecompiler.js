...
TableCompiler_SQLite3.prototype.primaryKeys = function () {
  const pks = (0, _lodash.filter)(this.grouped.alterTable || [], { method: 'primary' });
...
TableCompiler_SQLite3.prototype.foreignKeys = function () {
  let sql = '';
  const foreignKeys = (0, _lodash.filter)(this.grouped.alterTable || [], { method: 'foreign' });
...
TableCompiler_SQLite3.prototype.dropColumn = function () {
  const compiler = this;
  const columns = (0, _values2.default)(arguments);
  this.pushQuery({
    sql: `PRAGMA table_info(${this.tableName()})`,
    output(pragma) {
