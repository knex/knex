 ...
 * @param {string} [constraintName] - Not supported in SQLite
 */
TableCompiler_SQLite3.prototype.primary = function (columns, constraintName) {
  ...
  if (this.method !== 'create' && this.method !== 'createIfNot') {
    if (constraintName) {
      this.logger.warn(
        `SQLite doesn't support custom primary key constraint names`
      );
    }
 ...
 * @param {string[]} foreignInfo.column - Columns in the current constraint
...
TableCompiler_SQLite3.prototype.foreign = function (foreignInfo) {
  ...
  if (this.method !== 'create' && this.method !== 'createIfNot') {
    foreignInfo.columns = this.formatter.columnize(foreignInfo.columns);
    foreignInfo.columns = Array.isArray(foreignInfo.columns)
      ? foreignInfo.columns
      : [foreignInfo.columns];
