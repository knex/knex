...
TableCompiler.prototype.getColumnTypes = function(columns) {
  return (0, _lodash.reduce)(
    (0, _lodash.map)(columns, _lodash.first),
...
TableCompiler.prototype.columnQueries = function(columns) {
  var queries = (0, _lodash.reduce)(
    (0, _lodash.map)(columns, _lodash.tail),
    function(memo, column) {
...
TableCompiler.prototype.getColumns = function(method) {
  ...
  return columns
    ...
    .map(function(column) {
      ...
      if (
        !(0, _lodash.isUndefined)(queryContext) &&
        (0, _lodash.isUndefined)(column.builder.queryContext())
      ) {
...
TableCompiler.prototype.alterTableForCreate = function(columnTypes) {
  ...
  for (var i = 0, l = alterTable.length; i < l; i++) {
    var statement = alterTable[i];
    if (
      (0, _lodash.indexOf)(this.createAlterTableMethods, statement.method) < 0
    ) {
...
TableCompiler.prototype.dropColumn = function() {
  ...
  var drops = (0, _lodash.map)(
    (0, _lodash.isArray)(columns) ? columns : [columns],
    function(column) {
