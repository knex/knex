...
// Default placeholder value for query bindings.
Formatter.prototype.placeholder = '?';

// Turns a list of values into a list of ?'s, joining them with commas unless
// a "joining" value is specified (e.g. ' and ')
Formatter.prototype.parameterize = function(values, joining) {
...
Formatter.prototype.parameter = function(value) {
  ...
  return this.checkRaw(value, true) || _.result(this, 'placeholder');
};
...
Formatter.prototype._wrapString = function(val) {
