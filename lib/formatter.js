...
var operators = (0, _lodash.transform)(
  [
    '=',
    '<',
    '>',
...
var Formatter = (function() {
  ...
  Formatter.prototype.parameterize = function parameterize(
    values,
    notSetValue
  ) {
  ...
  Formatter.prototype.wrap = function wrap(value) {
    ...
    if (raw) return raw;
    switch (
      typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)
    ) {
      case 'function':
        return this.outputQuery(this.compileCallback(value), true);
      case 'object':
  ...
  Formatter.prototype.compileCallback = function compileCallback(
    callback,
    method
  ) {
  ...
  Formatter.prototype.outputQuery = function outputQuery(
    compiled,
    isParameter
  ) {
