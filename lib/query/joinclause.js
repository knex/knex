...
(0, _lodash.assign)(JoinClause.prototype, {
  ...
  on(first, operator, second) {
    ...
    switch (arguments.length) {
      case 1:
        {
          if (typeof first === 'object' && typeof first.toSQL !== 'function') {
            const keys = (0, _keys2.default)(first);
            let i = -1;
      ...
      case 2:
        data = { type: 'onBasic', column: first, operator: '=', value: operator, bool };break;
      default:
        data = { type: 'onBasic', column: first, operator, value: second, bool };
    }
