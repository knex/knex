...
module.exports = function(client) {
  ...
  _.extend(QueryBuilder.prototype, Formatters, {
    ...
    clone: function() {
      ...
      cloned.bindings = this.bindings.slice();
    ...
    _aggregate: bindings(function(method, column) {
  ...
  QueryBuilder.prototype.then = function QueryBuilder$then(onFulfilled, onRejected) {
