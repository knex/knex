...
class QueryCompiler {
  ...
  _columnClause(statement) {
    ...
    if (Array.isArray(statement.column)) {
      ...
      /**
       * fix of whereIn Oracle DB restriction (max number of values in where is 1000 expression in a list)
       * @param {*} arr 
       * @param {*} start 
       * @param {*} amount 
       * @returns 
      ...
      /**
       * checking condition for more than 1000 values in query
       * break query into two part using where in (....) OR .... in (.....)
       */
