...
class QueryCompiler {
  ...
  _prepUpdate(data = {}) {
    ...
    for (const column of Object.keys(counter)) {
      ...
      // https://github.com/knex/knex/issues/6096 - relies on number type for operator
      // Perhaps we should retain original method to denote the operator here. 
      // Then we remove the need to convert to Number which creates issues with larger than Math.MAX_SAFE_INTEGER.
