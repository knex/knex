...
class Builder extends EventEmitter {
  ...
  whereLike(column, values) {
    return this._whereLike('whereLike', column, values);
  }

  // Adds a `where ilike` clause to the query.
  whereILike(column, values) {
    return this._whereLike('whereILike', column, values);
  }
