...
class Builder extends EventEmitter {
  ...
  innerJoin(table, first, operator, second) {
    return this._joinType('inner').join(table, first, operator, second);
  }

  leftJoin(table, first, operator, second) {
    return this._joinType('left').join(table, first, operator, second);
  }

  leftOuterJoin(table, first, operator, second) {
    return this._joinType('left outer').join(table, first, operator, second);
  }

  rightJoin(table, first, operator, second) {
    return this._joinType('right').join(table, first, operator, second);
  }

  rightOuterJoin(table, first, operator, second) {
    return this._joinType('right outer').join(table, first, operator, second);
  }

  outerJoin(table, first, operator, second) {
    return this._joinType('outer').join(table, first, operator, second);
  }

  fullOuterJoin(table, first, operator, second) {
    return this._joinType('full outer').join(table, first, operator, second);
  }

  crossJoin(table, first, operator, second) {
    return this._joinType('cross').join(table, first, operator, second);
  }

  joinRaw(table, first, operator, second) {
    return this._joinType('raw').join(table, first, operator, second);
  }
  ...
  where(column, operator, value) {
    ...
    if (column && column.isRawInstance && arguments.length === 1)
  ...
  whereColumn(column, operator, rightColumn) {
    ...
    this.where(column, operator, rightColumn);
    this._asColumnFlag = false;
    return this;
  }
  ...
  whereNot(column, operator, value) {
    ...
    return this._not(true).where(column, operator, value);
  }

  whereNotColumn(column, operator, value) {
    return this._not(true).whereColumn(column, operator, value);
  }

  // Adds an `or not where` clause to the query.
  orWhereNot(column, operator, value) {
    return this._bool('or').whereNot(column, operator, value);
  }

  orWhereNotColumn(column, operator, value) {
    return this._bool('or').whereNotColumn(column, operator, value);
  }
  ...
  having(column, operator, value) {
    if (column.isRawInstance && operator === undefined) {
  ...
  rank(alias, second, third) {
    return this._analyticMethod('rank')._analytic(alias, second, third);
  }

  denseRank(alias, second, third) {
    return this._analyticMethod('dense_rank')._analytic(alias, second, third);
  }

  rowNumber(alias, second, third) {
    return this._analyticMethod('row_number')._analytic(alias, second, third);
  }
