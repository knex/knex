...
class QueryCompiler {
  constructor(client, builder) {
    ...
    this._rawTransformers = builder._rawTransformers;
  ...
  toSQL(method, tz) {
    ...
    this._rawTransformers.forEach(transformer => {
      let transformed = transformer(query);
      if (!isNil(transformed)) query = transformed;
    });
