...
(0, _lodash.assign)(Builder.prototype, {
  ...
  where(column, operator, value) {
    ...
    if ((0, _lodash.isObject)(column) && !(column instanceof _raw2.default)) return this._objectWhere(column);
  ...
  orWhere: function orWhere() {
    ...
    if ((0, _lodash.isObject)(obj) && !(0, _lodash.isFunction)(obj) && !(obj instanceof _raw2.default)) {
  ...
  whereRaw(sql, bindings) {
    const raw = sql instanceof _raw2.default ? sql : this.client.raw(sql, bindings);
    this._statements.push({
      grouping: 'where',
      type: 'whereRaw',
      value: raw,
  ...
  update(values, returning) {
    ...
    if ((0, _lodash.isString)(values)) {
      ...
      const keys = (0, _keys2.default)(values);
  ...
  _clearGrouping(grouping) {
    this._statements = (0, _lodash.reject)(this._statements, { grouping });
  }
});
