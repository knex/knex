...
QueryBuilder.prototype.tapSql = function(handler) {
  var sql = this.toSql();
...
QueryBuilder.prototype.clone = function() {
  var cloned = new this.constructor();
    ...
    cloned._options     = this._options.slice();
...
QueryBuilder.prototype.orHaving = function(column, operator, value) {
...
// Sets the "transacting" value for a query.
QueryBuilder.prototype.transacting = function(t) {
  this._transacting = t;
  return this;
};

// Sets an explicit "connnection" we wish to use for this query.
QueryBuilder.prototype.connection = function(t) {
  this._connection = t;
  return this;
};
