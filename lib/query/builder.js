...
assign(Builder.prototype, {
  ...
  transformRaw(transformer) {
    if (!isFunction(transformer)) {
      throw new TypeError("Expected provided transformer to be a function");
    }
    this._rawTransformers.push(transformer);
    return this;
  },
  ...
  clone() {
    ...
    cloned._rawTransformers = clone(this._rawTransformers);
