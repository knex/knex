...
function Builder(client) {
  ...
  this._method = 'select';
  if (client.config) {
    (0, _saveAsyncStack2.default)(this, 5);
...
(0, _lodash.assign)(Builder.prototype, {
  ...
  with: function _with(alias, statement) {
    ...
    if (
      ...
      statement instanceof _raw2.default
    ) {
  ...
  where: function where(column, operator, value) {
    ...
    if ((0, _lodash.isObject)(column) && !(column instanceof _raw2.default))
  ...
  orWhere: function orWhere() {
    ...
    var obj = arguments[0];
    if (
      (0, _lodash.isObject)(obj) &&
      !(0, _lodash.isFunction)(obj) &&
      !(obj instanceof _raw2.default)
    ) {
  ...
  whereRaw: function whereRaw(sql, bindings) {
    var raw =
      sql instanceof _raw2.default ? sql : this.client.raw(sql, bindings);
    this._statements.push({
      grouping: 'where',
      type: 'whereRaw',
      value: raw,
  ...
  whereIn: function whereIn(column, values) {
    if (Array.isArray(values) && (0, _lodash.isEmpty)(values))
  ...
  union: function union(callbacks, wrap) {
    if (
      arguments.length === 1 ||
      (arguments.length === 2 && (0, _lodash.isBoolean)(wrap))
    ) {
      ...
      callbacks = (0, _lodash.toArray)(arguments).slice(
        0,
        arguments.length - 1
      );
  ...
  fromJS: function fromJS(obj) {
    ...
    (0, _lodash.each)(obj, function(val, key) {
      if (typeof _this[key] !== 'function') {
        _this.client.logger.warn('Knex Error: unknown key ' + key);
      }
