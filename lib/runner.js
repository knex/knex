...
(0, _lodash.assign)(Runner.prototype, {
  ...
  query: _bluebird2.default.method(function (obj) {
    ...
    this.builder.emit('query', (0, _lodash.assign)({ __knexUid: __knexUid, __knexTxId: __knexTxId }, obj));
    ...
    return queryPromise.then(function (resp) {
      ...
      _this.builder.emit('query-response', postProcessedResponse, (0, _lodash.assign)({ __knexUid: _this.connection.__knexUid }, obj), _this.builder);

      _this.client.emit('query-response', postProcessedResponse, (0, _lodash.assign)({ __knexUid: _this.connection.__knexUid }, obj), _this.builder);
