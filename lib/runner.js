...
(0, _lodash.assign)(Runner.prototype, {
  ...
  stream(options, handler) {
    ...
    const promise = _bluebird2.default.using(this.ensureConnection(), function (connection) {
      hasConnection = true;
      runner.connection = connection;
      const sql = runner.builder.toSQL();
  ...
  query: _bluebird2.default.method(function (obj) {
    ...
    this.builder.emit('query', (0, _lodash.assign)({ __knexUid, __knexTxId }, obj));
    ...
    return queryPromise.then(resp => {
      ...
      this.builder.emit('query-response', postProcessedResponse, (0, _lodash.assign)({ __knexUid: this.connection.__knexUid }, obj), this.builder);

      this.client.emit('query-response', postProcessedResponse, (0, _lodash.assign)({ __knexUid: this.connection.__knexUid }, obj), this.builder);

      return postProcessedResponse;
    }).catch(_bluebird2.default.TimeoutError, error => {
      ...
      this.builder.emit('query-error', error, (0, _lodash.assign)({ __knexUid: this.connection.__knexUid }, obj));
      throw error;
    });
  }),
  ...
  ensureConnection() {
    ...
    return this.client.acquireConnection().catch(_bluebird2.default.TimeoutError, error => {
      if (this.builder) {
