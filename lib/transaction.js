...
function Transaction(client, container, config, outerTx) {
  ...
  if (outerTx) {
    throw new Error('Nested transactions not yet supported')
  }
...
function makeTransactor(trx, connection, trxClient) {
  ...
  transactor.transaction = function(container, options) {
    return new transactor.Transaction(trxClient, container, options, trx)
  }  
...
function makeTxClient(trx, client, connection) {
  ...
  trxClient.query  = function(conn, obj) {
    return Promise.try(function() {
      ...
      return client.query.call(trxClient, conn, obj)
    })
  }
  trxClient.stream = function(conn, obj, stream, options) {
    return Promise.try(function() {
      if (conn !== connection) throw new Error('Invalid connection for transaction query.')
      return client.stream.call(trxClient, conn, obj, stream, options)
    })
  }
