...
function initContext(knexFn) {
  ...
  Object.assign(knexContext, {
    ...
    cast(value, to, alias) {
      return this.client.cast.apply(this.client, arguments);
    },

    castDouble(value, alias) {
      return this.client.castDouble.apply(this.client, arguments);
    },

    castChar(value, length, alias) {
      return this.client.castChar.apply(this.client, arguments);
    },

    castJson(value, alias) {
      return this.client.castJson.apply(this.client, arguments);
    },

    castJsonb(value, alias) {
      return this.client.castJsonb.apply(this.client, arguments);
    },

    castReal(value, alias) {
      return this.client.castReal.apply(this.client, arguments);
    },

    castInt(value, alias) {
      return this.client.castInt.apply(this.client, arguments);
    },

    castBigint(value, alias) {
      return this.client.castBigint.apply(this.client, arguments);
    },

    castBinary(value, alias) {
      return this.client.castBinary.apply(this.client, arguments);
    },

    castText(value, alias) {
      return this.client.castText.apply(this.client, arguments);
    },
