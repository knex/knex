...
class Cast extends Raw {
  ...
  _getColType(type) {
    ...
    switch (this.client.config.client) {
      case 'mssql':
        columnCompiler = ColumnCompiler_MSSQL;
        break;
      case 'mysql':
      case 'mysql2':
        ...
        break;
      case 'oracledb':
        columnCompiler = ColumnCompiler_Oracledb;
        break;
      case 'postgres':
      case 'cockroachdb':
      case 'pgnative':
        columnCompiler = ColumnCompiler_PG;
        break;
      case 'pg-redshift':
        columnCompiler = ColumnCompiler_Redshift;
        break;
      case 'sqlite3':
      case 'better-sqlite3':
        columnCompiler = ColumnCompiler_SQLite3;
        break;
    }
    ...
    return columnCompiler.prototype[type];
  }
