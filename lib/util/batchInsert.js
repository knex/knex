  ...
  var wrapper = (0, _lodash.assign)(
    new _bluebird2.default(function(resolve, reject) {
      ...
      if (!(0, _lodash.isArray)(batch)) {
        return reject(
          new TypeError(
            'Invalid batch: Expected array, got ' +
              (typeof batch === 'undefined'
                ? 'undefined'
                : (0, _typeof3.default)(batch))
          )
        );
      }
      ...
      return _bluebird2.default
        ...
        .then(function(tr) {
          return _bluebird2.default
            .mapSeries(chunks, function(items) {
            ...
            .then(function(result) {
              ...
              if (autoTransaction) {
                ...
                return (tr.commit(result) || _bluebird2.default.resolve()).then(
                  function() {
                    return result;
                  }
                );
