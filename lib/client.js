...
class Client extends EventEmitter {
  ...
  getPoolSettings(poolConfig) {
    ...
    const maxConnectionLifetimeMillis = poolConfig.maxConnectionLifetimeMillis;
    const maxConnectionLifetimeJitterMillis =
      poolConfig.maxConnectionLifetimeJitterMillis;
    const userValidate = poolConfig.validate;
    delete poolConfig.maxConnectionLifetimeMillis;
    delete poolConfig.maxConnectionLifetimeJitterMillis;
    delete poolConfig.validate;
