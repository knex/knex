...
const { ResultMapper } = require('./query/cast.js');
...
class Client extends EventEmitter {
  ...
  /**
   * @param {import('./query/querybuilder')} builder
   * @returns {ResultMapper<any>|undefined}
   */
  resultMapper(builder) {
    if (builder._cast === undefined) return undefined;
    if (builder._cast instanceof ResultMapper) return builder._cast;
    return new ResultMapper(builder._cast);
  }
