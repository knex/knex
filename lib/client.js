...
class Client extends EventEmitter {
  ...
  cast(value, to, alias) {
    return new Cast(this).cast(value, to, alias);
  }

  castDouble(value, alias) {
    return new Cast(this).castDouble(value, alias);
  }

  castChar(value, length, alias) {
    return new Cast(this).castChar(value, length, alias);
  }

  castJson(value, alias) {
    return new Cast(this).castJson(value, alias);
  }

  castJsonb(value, alias) {
    return new Cast(this).castJsonb(value, alias);
  }

  castReal(value, alias) {
    return new Cast(this).castReal(value, alias);
  }

  castInt(value, alias) {
    return new Cast(this).castInt(value, alias);
  }

  castBigint(value, alias) {
    return new Cast(this).castBigint(value, alias);
  }

  castBinary(value, alias) {
    return new Cast(this).castBinary(value, alias);
  }

  castText(value, alias) {
    return new Cast(this).castText(value, alias);
  }
