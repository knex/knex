...
const { availablePromiseMethods } = require('./util/promises');
...
function Client(config = {}) {
  ...
  const library = config.promiseLibrary || Promise;
  this.promises = {
    library,
    availableMethods: availablePromiseMethods(
      library,
      config.promiseLibraryMethods
    ),
  };
